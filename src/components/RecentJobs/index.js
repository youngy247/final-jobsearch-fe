...
const RecentJobs = () => {
    ...
    useEffect(() => {
        document.querySelector('tbody').innerHTML = createRecentTable(recentJobs)
    }, [recentJobs])
            ...
            return data.map((job, key) => {
                return (
                    <tr key={key}>
                        ...
                        <td className="row-span-2">{job.skills.map((skill) => {
                            return skill.skill
                        })
                        }
                        </td>
    ...
    return (
        <div className='container'>
            <table className="table table-dark table-striped">
                <thead>
                <tr>
                    <th className='col-6' colSpan='2' scope="col">Job Title/ Company</th>
